    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        when (call.method) {
            ...
            "compressVideo" -> {
                ...
                val startTime = call.argument<Double>("startTime")?.toLong()
                val duration = call.argument<Double>("duration")?.toLong()
                ...
                val dataSource = if (startTime != null || duration != null){
                    ...
                    TrimDataSource(source, (1000 * 1000 * (startTime ?: 0)).toLong(), (1000 * 1000 * (startTime ?: 0)+(duration ?: 0))).toLong())
                } else {
